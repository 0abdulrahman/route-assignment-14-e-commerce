...
import download from "../../../assets/images/footer/th.png";
    ...
    <footer className={styles.footer}>
      <section className="container">
        ...
        <form className="d-flex gap-2 gap-sm-4 flex-wrap flex-sm-nowrap">
          ...
          <button className="main-bg rounded-2 py-2 px-5 text-white" style={{ whiteSpace: "nowrap" }}>
            Share App Link
          </button>
        </form>
        <hr />
        <div className="links d-flex gap-5 gap-md-3 justify-content-between flex-wrap">
          ...
          <div className="download d-flex gap-1 align-items-center gap-sm-3 flex-wrap">
            ...
            <img src={download} alt="Download" width={300} />
          </div>
        </div>
      </section>
    </footer>
